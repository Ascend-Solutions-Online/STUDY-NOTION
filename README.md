...
6. Future Enhancements: The list of potential future enhancements to the platform, explanation of how these enhancements would improve the platform, estimated timeline and priority for implementing these enhancements.
...
The front end of StudyNotion has all the necessary pages that an ed-tech platform should have. 
